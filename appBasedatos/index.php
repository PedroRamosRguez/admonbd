...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form action="index.php" name = "Buscar" method="get">
...
if(empty($_GET['Buscar'])){
   ...
   if(!empty($order))
    ...
    <table class="highlight" class="centered">
        <tr>
            <td></td>
            <td><a style="color:black;" href="index.php?sort=Nombre">Nombre</a></td>
            <td><a style="color:black;" href="index.php?sort=Genero">Genero</a></td>
            <td><a style="color:black;" href="index.php?sort=Director">Director</a></td>
        </tr>    
